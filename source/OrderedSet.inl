...
namespace Langulus::Anyness
{
   ...
   inline OrderedSet::OrderedSet(Disowned<OrderedSet>&& other) noexcept
   ...
   inline OrderedSet::OrderedSet(Abandoned<OrderedSet>&& other) noexcept
      : BlockSet {other.Forward<BlockSet>()} { }

   /// Clone the set                                                          
   ///   @return the cloned set                                               
   inline OrderedSet OrderedSet::Clone() const {
      OrderedSet cloned;
